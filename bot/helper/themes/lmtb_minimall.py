...
class  LMTBStyle:
    ...
    ST_BN1_NAME = '🤖 STaR Bots'
    ST_BN1_URL = 'https://telegram.me/STARZLEECH'
    ST_BN2_NAME = '🆕 Updates 🔥'
    ST_BN2_URL = 'https://telegram.me/Star_Linkz'
...
💡 Type {help_command} to get a list of available commands</b>'''
    ...
    ST_UNAUTH = '''⛔️ <i>You Are not authorized user! Deploy your own STAR-X Mirror-Leech bot</i>'''
    OWN_TOKEN_GENERATE = '''⚠️ <b>Temporary Token is not yours!</b>\n\n<i>Kindly generate your own.</i>'''
    USED_TOKEN = '''⚠️ <b>Temporary Token already used!</b>\n\n<i>Kindly generate a new one.</i>'''
...
<b>Validity:</b> {validity}'''
    ...
    LOGIN_USED = 'ℹ️ <b>Bot Login Usage :</b>\n\n<code>/cmd [password]</code>'
    # ---------------------
...
------------------------------------------\n\n"""
    ...
    RCPATH =                '🗂️ <b>Path: </b><code>{RCpath}</code>\n'
    M_CC =                  '👤 <b>By: </b>{Tag}\n\n'
    ...
    STATUS =            '\nℹ️ <b>Status:</b> <a href="{Url}">{Status}</a>'
    ETA =                                                ' | ⏳ <b>ETA:</b> {Eta}'
    SPEED =             '\n⚡ <b>Speed:</b> {Speed}'
